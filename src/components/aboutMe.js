      ...
      <div className="text-center textos-home">
        ...
        <div className="descargar-cv">
          ...
          <a
            className="mt-4"
            href={CvGabrielAyala}
            download="CvGabrielAyala2023.pdf"
          >
        ...
        <div className="contAboutMe">
          ...
          <div className="about-me">
            ...
            <p>
              Mi nombre es Gabriel Ayala Gimenez, tengo 25 años. Actualmente
              estoy viviendo en Buenos Aires. <br></br>
              Me capacite como Desarrollador Web Full Stack gracias al Bootcamp
              de Educación IT. <br></br> Actualmente cuento con conocimientos en
              lo que es HTML, CSS, JavaScript, NodeJS, React.
            </p>
          </div>
        </div>
        ...
        <article className="contactame">
          ...
          <div className="contacto-redes py-5">
            <a
              href="https://github.com/Gabriel-Ayala20"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/gabriel-ayala-gimenez-1b17bb1a9/"
              target="_blank"
              rel="noopener noreferrer"
            >
